...
// ─── VENUE DATABASE (from your spreadsheet + common venues) ────────────────
const VENUE_DB = [
  // NSW - Sydney
  ...
  { city:"Sydney", state:"NSW", name:"Hordern Pavilion", cap:5500, hire:6000, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"State Theatre", cap:2000, hire:4000, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Factory Theatre", cap:900, hire:1800, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Roundhouse", cap:1600, hire:2500, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Oxford Art Factory", cap:800, hire:1500, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Manning Bar", cap:1100, hire:1800, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Lansdowne", cap:600, hire:0, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Marys Underground", cap:400, hire:0, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"Qudos Bank Arena", cap:21000, hire:35000, perHead:5.5 },
  { city:"Sydney", state:"NSW", name:"ICC Sydney Theatre", cap:8000, hire:12000, perHead:5.5 },
  ...
  // Newcastle
  { city:"Newcastle", state:"NSW", name:"Newcastle Entertainment Centre", cap:7000, hire:8000, perHead:5.5 },
  { city:"Newcastle", state:"NSW", name:"Civic Theatre Newcastle", cap:1550, hire:2500, perHead:5.5 },
  { city:"Newcastle", state:"NSW", name:"King St Main Band Room", cap:600, hire:800, perHead:5.5 },
  // Wollongong
  ...
  { city:"Melbourne", state:"VIC", name:"Palais Theatre", cap:3000, hire:5000, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"The Corner Hotel", cap:800, hire:0, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Prince Bandroom", cap:1000, hire:1200, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Margaret Court Arena", cap:10500, hire:18000, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Rod Laver Arena", cap:15000, hire:25000, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Hamer Hall", cap:2600, hire:6000, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Northcote Theatre", cap:1000, hire:1800, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Croxton Bandroom", cap:800, hire:0, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Hi-Fi Bar", cap:1300, hire:1500, perHead:5.5 },
  { city:"Melbourne", state:"VIC", name:"Sidney Myer Music Bowl", cap:12000, hire:20000, perHead:5.5 },
  // QLD - Brisbane
  { city:"Brisbane", state:"QLD", name:"Fortitude Music Hall", cap:2200, hire:3500, perHead:5.5 },
  ...
  { city:"Perth", state:"WA", name:"Perth Arena", cap:14000, hire:22000, perHead:5.5 },
  // Gold Coast
  ...
  { city:"Launceston", state:"TAS", name:"Royal Oak", cap:500, hire:0, perHead:5.5 },
];
